...
rawset <- try(ArrayExpress("E-MTAB-685"))
...
sample(fData(study))
pData(study)
 RG          <- read.maimages(study$Array.Data.File ,source = "generic", columns = list(R= "rojo_forward" ,G= "verde_forward",Rb="rojo_background" ,Gb="verde_background"), annotation = c("ProbeName", "SequenceID"))
