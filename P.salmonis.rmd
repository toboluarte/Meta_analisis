...
red <- assayDataElement(study,"R")
red_back <- assayDataElement(study,"Rb")
green = assayDataElement(study,"G")
green_back <- assayDataElement(study,"Gb")
Sequence_probs <- parsing_from_match_to_end("~/Documentos/Meta_analisis_teleosteos/Meta_analisis/A-MEXP-2065.adf.txt")

v5_95_Feb07_1_1 <- as.data.frame(cbind(red[,"10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], red_back[,"10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], green[, "10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], green_back[, "10031 2 uncom tif_GE2-v5_95_Feb07_1_1"]))
...
v5_95_Feb07_1_2 <- as.data.frame(cbind(red[,"10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], red_back[,"10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], green[, "10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], green_back[, "10031 2 uncom tif_GE2-v5_95_Feb07_1_1"]))
...
v5_95_Feb07_1_3 <- as.data.frame(cbind(red[,"10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], red_back[,"10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], green[, "10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], green_back[, "10031 2 uncom tif_GE2-v5_95_Feb07_1_1"]))
...
v5_95_Feb07_1_4 <- as.data.frame(cbind(red[,"10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], red_back[,"10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], green[, "10031 2 uncom tif_GE2-v5_95_Feb07_1_1"], green_back[, "10031 2 uncom tif_GE2-v5_95_Feb07_1_1"]))
...
test<-inner_join(v5_95_Feb07_1_1_row, Sequence_probs, by = "Row")
 write_delim(test, path= "~/Documentos/Meta_analisis_teleosteos/Meta_analisis/10031 2 uncom tif_GE2-v5_95_Feb07_1_1_corrected", delim = "\t", na = "NA", append = FALSE)
test2<-inner_join(v5_95_Feb07_1_2_row, Sequence_probs, by = "Row")
write_delim(test2, path= "~/Documentos/Meta_analisis_teleosteos/Meta_analisis/10031 2 uncom tif_GE2-v5_95_Feb07_1_2_corrected", delim = "\t", na = "NA", append = FALSE)
test3<-inner_join(v5_95_Feb07_1_3_row, Sequence_probs, by = "Row")
write_delim(test3, path= "~/Documentos/Meta_analisis_teleosteos/Meta_analisis/10031 2 uncom tif_GE2-v5_95_Feb07_1_3_corrected", delim = "\t", na = "NA", append = FALSE)
test4<-inner_join(v5_95_Feb07_1_4_row, Sequence_probs, by = "Row")
write_delim(test4, path= "~/Documentos/Meta_analisis_teleosteos/Meta_analisis/10031 2 uncom tif_GE2-v5_95_Feb07_1_4_corrected", delim = "\t", na = "NA", append = FALSE)


Accesion <- c("10031", "10031" , "10031" ,"10031")
Cy3 <- c("Control","Control","Control","Control")
Cy5 <- c("Infected", "Infected","Infected","Infected")
Filename <- c("~/Documentos/Meta_analisis_teleosteos/Meta_analisis/10031 2 uncom tif_GE2-v5_95_Feb07_1_1_corrected","~/Documentos/Meta_analisis_teleosteos/Meta_analisis/10031 2 uncom tif_GE2-v5_95_Feb07_1_2_corrected","~/Documentos/Meta_analisis_teleosteos/Meta_analisis/10031 2 uncom tif_GE2-v5_95_Feb07_1_3_corrected","~/Documentos/Meta_analisis_teleosteos/Meta_analisis/10031 2 uncom tif_GE2-v5_95_Feb07_1_4_corrected")
target_test <- data.frame(Cy3, Cy5, Accesion, Filename)


 RG          <- read.maimages(target_test$Filename ,source = "generic", columns = list(R= "rojo_forward" ,G= "verde_forward",Rb="rojo_background" ,Gb="verde_background"), annotation = c("ProbeName", "SequenceID"))
