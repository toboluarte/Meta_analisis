...
Cabe destacar que el formato en el que vienen estos archivos no es util para nuestros propositos por lo que se utilizara el programa fastq-dump para transformarlos en fastq
